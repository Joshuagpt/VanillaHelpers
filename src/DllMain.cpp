...
// exit-time SGroupPtr/SMem3 crash. Already tested with this at 1 and the crash still
// occurred, so Allocator.cpp is ruled out - leaving this at 0 now.
#define VH_TEST_DISABLE_ALLOCATOR 0
